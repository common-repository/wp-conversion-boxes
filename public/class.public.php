        ...
        public function show_the_box($id,$attributes = null){
            ...
            switch($box_type){
                ...
                case 4 :    include(WPCB_TEMPLATE_DIR_PATH.$this->get_template_directory(4).'/'.$box_template.'/template.php');
                            break;
                case 5 :    if(isset($attributes['style']) && $attributes['style'] != 'image'){
                                    ...
                                    $img_url = isset($attributes['image_url']) ? $attributes['image_url'] : '';
                                    $anchor = '<img src="'.$img_url.'" class="wpcb_2_step_button_img_'.$box_id.'"/>';
                                    $style = explode('_', 'none_none');
                                }
